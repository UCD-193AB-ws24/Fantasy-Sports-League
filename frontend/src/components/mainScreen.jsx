...
import BostonCelts from "./BostonCelts";
...
const backgrounds = [
  ...
  },
  {
    ...
    buttonText: "Demo This!",
    buttonLink: "/YourRoster",
  },
  {
    ...
    <div className="main-container">
      ...
      <div className="main-picture" style={{ backgroundImage: `url(${backgrounds[index].image})` }}>
        ...
        <div className="background-text">
          ...
          <p className="moreInfo">{backgrounds[index].moreInfo}</p>

              {backgrounds[index].buttonText && backgrounds[index].buttonLink && (
                <a href={backgrounds[index].buttonLink} className="roster-button">
                  {backgrounds[index].buttonText}
                </a>
              )}
        ...
        <div className="main-Info">
          ...
          <div className="three-column-container">
            <div className="timeline-section">
              <BostonCelts onEventClick={handleEventClick} />
            </div>
