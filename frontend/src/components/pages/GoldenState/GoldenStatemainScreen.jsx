...
import './GoldenState.css';
import GoldenState from './GoldenState'
    ...
    <div className="main-container">
      ...
      <div className="main-picture" style={{ backgroundImage: `url(${backgrounds[index].image})` }}>
        ...
        <div className="main-Info">
          ...
          <div className="goldenState-container">
            <div className="timeline-section">
              <GoldenState onEventClick={handleEventClick} />
            </div>
...
export default GoldenStatemainScreen;