...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    // Add this line to redirect to login page after successful registration
    navigate('/login');
  } catch (error) {
    ...
    <div>
      ...
      <div className="register-wrapper">
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          <input type="text" name="name" placeholder="Username" className="input-field" onChange={handleChange} required />
